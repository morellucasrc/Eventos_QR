...
export default function RegistroForm() {
  ...
  return (
    ...
    <div className="registro-form">
      ...
      <div className="hola">
        <p>sta aplicación está pensada para que puedas llevar el control de tus eventos de forma fácil y rápida. Desde el primer momento, vas a poder registrar personas escaneando sus códigos QR, sin necesidad de hacer listas a mano ni usar papeles.
